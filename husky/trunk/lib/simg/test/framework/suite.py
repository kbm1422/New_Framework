...
=======
        test.cycleindex = self.getTestCycleIndex(test)
        test.record.cycleindex = test.cycleindex
        test.logname = os.path.join(test.logdir, "%s_%s.log" % (test.name, test.cycleindex))
>>>>>>> .r142
